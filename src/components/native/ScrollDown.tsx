...
export default function ScrollDown() {
    ...
    return (
    <div id='scroll-down-animated-icon' className='relative h-20 w-12 rounded-3xl border-4 border-raisin_black-900'> 
        <div id='scroll-down-animated-icon-midButton' className='absolute top-1/2 left-1/2 -translate-x-1/2  h-5 w-1 rounded-3xl bg-raisin_black-900'></div>
    </div>
  )
}
